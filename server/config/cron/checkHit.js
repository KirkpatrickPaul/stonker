...
const checkHit = async (company, newTrend) => {
  try {
    ...
    console.error(`checkHit: Error creating top hit for company ${company.symbol}: ${err.message}`);
    return null;
  }
};
